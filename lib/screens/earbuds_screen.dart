...
class _EarbudsScreenState extends State<EarbudsScreen>
  ...
  bool _isOn = false; // Figma shows "Off" by default for Earbuds
    ...
    return Scaffold(
      ...
      body: FadeTransition(
        ...
        child: Stack(
          fit: StackFit.expand,
          children: [
            // ── Background — صورة الـ Earbuds ────────────
            Positioned.fill(
              child: Image.asset(
                'assets/images/Earbuds.jpeg',
                fit: BoxFit.cover,
...
// ════════════════════════════════════════════════════════════
//  STATUS CARD  — Figma: 305×202, radius 24, #000000 20%, blur 12
// ════════════════════════════════════════════════════════════
