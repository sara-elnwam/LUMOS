// lib/screens/earbuds_screen.dart
import 'dart:ui';
...
class EarbudsScreen extends StatefulWidget {
  const EarbudsScreen({super.key});
  @override
  State<EarbudsScreen> createState() => _EarbudsScreenState();
}

class _EarbudsScreenState extends State<EarbudsScreen>
  ...
  Future<void> _toggle(bool v) async {
    ...
    if (p.isVoiceMode) {
      await LumosVoiceService.instance.speak(
        v ? p.tr('earbuds_on') : p.tr('earbuds_off'),
        lang: p.langCode, gender: p.voiceGender,
      );
    }
  }
      ...
      body: FadeTransition(
        ...
        child: Stack(
          ...
          children: [
            Positioned.fill(
              child: Image.asset(
                'assets/images/Earbuds.jpeg', fit: BoxFit.cover,
  ...
  PreferredSizeWidget _buildAppBar(BuildContext context, LocaleProvider p) {
    return AppBar(
      ...
      title: Text(p.tr('earbuds'), style: GoogleFonts.manrope(
          ...
          child: Container(
              ...
              decoration: BoxDecoration(
                ...
                boxShadow: [
                  ...
                  BoxShadow(color: Colors.black.withOpacity(0.23), blurRadius: 21.21, offset: const Offset(10, 10)),
                ],
              ),
              child: Column(
  ...
  Widget _buildNavItem(BuildContext context, IconData icon, int index) {
    ...
    return GestureDetector(
      onTap: () {
        ...
        else if (index == 2) Navigator.push(context, MaterialPageRoute(builder: (_) => const MedicalProfileScreen()));
      ...
      child: Container(
        ...
        child: Icon(icon, color: isActive ? const Color(0xFFF27F0D) : Colors.white.withOpacity(0.45), size: 26),
      ),
    );
  }
}