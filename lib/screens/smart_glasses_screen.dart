...
class SmartGlassesScreen extends StatefulWidget {
  const SmartGlassesScreen({super.key});
  @override
  State<SmartGlassesScreen> createState() => _SmartGlassesScreenState();
}

class _SmartGlassesScreenState extends State<SmartGlassesScreen>
